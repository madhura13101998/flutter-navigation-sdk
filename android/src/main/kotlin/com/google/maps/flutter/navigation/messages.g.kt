...
data class MarkerOptionsDto (
  ...
  companion object {
    ...
    fun fromList(list: List<Any?>): MarkerOptionsDto {
      ...
      val markerId = list[11] as String?
      return MarkerOptionsDto(alpha, anchor, draggable, flat, consumeTapEvents, position, rotation, infoWindow, visible, zIndex, icon, markerId)
    }
  }
  fun toList(): List<Any?> {
    return listOf<Any?>(
